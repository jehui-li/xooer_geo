"""
Grok (X API) 客户端测试脚本
注意：需要配置 X_BEARER_TOKEN 或 X_API_KEY 环境变量才能运行
"""
...
from src.connectors.grok_client import GrokClient, get_client


async def test_simple_query():
    """测试简单查询"""
    print("=" * 50)
    print("测试 Grok 客户端 - 简单查询")
    print("=" * 50)
    ...
    try:
        ...
        print(f"\n❌ 配置错误: {e}")
        print("请确保在 .env 文件中设置了 X_BEARER_TOKEN 或 X_API_KEY")
        return False
